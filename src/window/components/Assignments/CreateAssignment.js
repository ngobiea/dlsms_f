...
import TimeInput from "../App/TimeInput";
import { isTimeBeforeDate } from "../../helper/util";

const CreateAssignment = () => {
  const { createAssignment, handleSubmit, errors, register, time, date } =
  ...
  return (
    <div className="bg-white-full h-full">
      <div className="flex flex-col h-full">
        <form
          onSubmit={handleSubmit(createAssignment)}
